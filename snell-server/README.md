...
- ✨ 自动安装 Snell v6.0.0rc（RC/Beta）服务器
- 🔄 自动生成随机端口和密钥
- 🌐 支持 IPv4/IPv6 双栈
- 🚀 自动配置系统服务
- 📱 自动生成 Surge 客户端配置
...
4. 支持重复运行，可用于升级或重新配置
5. 生成的 Surge 配置使用 `version = 6`
6. Snell v6 当前仍处于测试阶段，需要 Surge iOS 5.20.0+ 或 Surge Mac 6.7.0+
7. 测试期间协议可能发生不兼容变更，服务端与 Surge 客户端需保持同步更新
